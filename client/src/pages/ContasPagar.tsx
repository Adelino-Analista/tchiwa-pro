...
const contasDemo = [
  { id: 1, fornecedor: "Fornecedor A", descricao: "Aluguel", valor: 3000, vencimento: "2026-03-25", status: "Pendente", dias: 3 },
  { id: 2, fornecedor: "Fornecedor B", descricao: "Energia", valor: 800, vencimento: "2026-03-30", status: "Pendente", dias: 8 },
  { id: 3, fornecedor: "Fornecedor C", descricao: "Internet", valor: 200, vencimento: "2026-03-20", status: "Atrasada", dias: -2 },
  { id: 4, fornecedor: "Fornecedor D", descricao: "Equipamentos", valor: 1500, vencimento: "2026-03-22", status: "Paga", dias: 0 },
  { id: 5, fornecedor: "Fornecedor E", descricao: "Materiais", valor: 600, vencimento: "2026-04-05", status: "Pendente", dias: 14 },
];
...
export default function ContasPagar() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader title="Contas a Pagar" subtitle="Gerenciar obrigações financeiras" />
              ...
              <tbody>
                {contasDemo.map((conta) => (
                  <tr key={conta.id} className="border-b hover:bg-gray-50">
                    <td className="py-3 px-4 font-medium">{conta.fornecedor}</td>
